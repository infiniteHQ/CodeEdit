...
public:
  ...
  bool Start(const std::string &rootPath, const std::string &executable,
...
private:
  ...
  public:
    // constructor/destructor
    Document(LspBridge &bridge, const std::string &path,
